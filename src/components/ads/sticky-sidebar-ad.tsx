...
const stickySidebarPlacements = {
  "left-160x600": {
    type: "banner-160x600",
    asideClassName:
      "pointer-events-none fixed left-4 top-0 hidden h-full w-[136px] lg:block 2xl:left-[max(1rem,_calc((100vw_-_80rem)_/_2_-_9.5rem))]",
  ...
  "right-160x300": {
    type: "banner-160x300",
    asideClassName:
      "pointer-events-none fixed right-4 top-0 hidden h-full w-[160px] lg:block 2xl:right-[max(1rem,_calc((100vw_-_80rem)_/_2_-_11rem))]",
