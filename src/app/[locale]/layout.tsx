...
const stickyAdContentOffsetClassName =
  [
    stickyLeftSidebarAdKey ? "lg:pl-[152px] 2xl:pl-0" : "",
      ...
      <body className="min-h-screen bg-background font-sans text-foreground antialiased">
        <ThemeProvider attribute="class" defaultTheme="dark" enableSystem={false}>
          <NextIntlClientProvider messages={messages}>
            ...
            <StickySidebarAd adKey={stickyLeftSidebarAdKey} />
            <StickySidebarAd placement="right-160x300" adKey={stickyRightSidebarAdKey} />
            <div className={stickyAdContentOffsetClassName}>
              {children}
